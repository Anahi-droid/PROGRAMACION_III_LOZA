function mostrarAlerta () {
    alert('Hola desde el boton de la academia');
}

function agregarProducto () {
    const lista = document.getElementById('lista-productos1');
    const nuevoProducto = document.createElement('li');
    nuevoProducto.textContent = 'Nuevo curso de idiomas';
...
document.getElementById('btn3').addEventListener('click', () => {
    ...
    const nuevoProducto = document.createElement('li');
    nuevoProducto.textContent = 'Nuevo curso desde listener';
    lista2.appendChild(nuevoProducto);
});

document.getElementById('btn4').addEventListener('click', () => {
    const mensaje = document.getElementById("mensaje");
    mensaje.textContent = "Texto modificado desde el boton de la academia";
